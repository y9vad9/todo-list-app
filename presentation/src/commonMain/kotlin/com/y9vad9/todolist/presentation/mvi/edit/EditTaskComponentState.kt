...
sealed interface EditTaskComponentState : MVIState {
    data object Loading : EditTaskComponentState
    ...
    data class Loaded(
        ...
        val isActionsAvailable: Boolean = true,
    ) : EditTaskComponentState {
        fun validated(): Loaded {
            return copy(
    ...
    data object NotFound : EditTaskComponentState
}